...
Este projeto implementa uma aplicação orientada a objetos em Java para gerenciar o aluguel de equipamentos de praia da empresa fictícia Sammy’s Seashore Supplies.
O sistema permite registrar aluguéis de diversos tipos de equipamentos (como caiaques, canoas, cadeiras de praia e guarda-sóis), calcular automaticamente o valor total com base no tempo e tipo do item, além de oferecer suporte a aulas para equipamentos que exigem treinamento.
